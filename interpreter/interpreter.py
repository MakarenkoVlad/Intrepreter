...
from interpreter.lexer import Lexer, TokenStream
from interpreter.parser import Parser
from interpreter.errors import InterpreterSyntaxError, report_syntax_error
...
def evaluate_env(s, env):
    ...
    except InterpreterSyntaxError as err:
